  ...
  <v-form @submit.prevent="submit">
    <v-row class="d-flex mb-3">
      ...
      <v-col cols="12">
        ...
        <v-text-field v-model="email" :error-messages="errors.email" variant="outlined" type="email" color="primary" />
      </v-col>
      <v-col cols="12">
      ...
      <v-col cols="12">
        <v-btn type="submit" color="primary" :loading="isSubmitting" size="large" block flat>Cadastrar</v-btn>
      </v-col>
    </v-row>
  </v-form>
</template>
